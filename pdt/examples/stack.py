"""Probabilistic Data Type for a Stack (FILO Queue)"""
from pdt import *
import mnist
# from ig.util import *
...
def gen_stack_adt(train_data, options, stack_shape=(1, 28, 28), push_args={},
...
def main(argv):
    ...
    save_dir = mk_dir(sfx)
    load_train_save(options, stack_adt, stack_pdt, sfx, save_dir)
    # push, pop = stack_pdt.call_fns
